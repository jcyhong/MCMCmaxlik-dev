...
timeSSModFixed  ## 71.496 
resultsSSModFixed$iter ## 300
mean(tail(resultsSSModFixed$param[, 1], 20), trim=.2)  # 0.004665499
mean(tail(resultsSSModFixed$param[, 2], 20), trim=.2)   # 8.935514
mean(tail(resultsSSModFixed$param[, 3], 20), trim=.2) #   51.29113
mean(tail(resultsSSModFixed$param[, 4], 20), trim=.2)  # 73.23133
...
timeSSModSmallFixed  ##717.904 
resultsSSModSmallFixed$iter ## 3000
mean(tail(resultsSSModSmallFixed$param[, 1], 20), trim=.2)  ## 0.3562996
mean(tail(resultsSSModSmallFixed$param[, 2], 20), trim=.2) ## 7.347145
mean(tail(resultsSSModSmallFixed$param[, 3], 20), trim=.2)  ##  4.878771
mean(tail(resultsSSModSmallFixed$param[, 4], 20), trim=.2) ## 5.658238
...
timeSSModAdadelta  ## 15.486 
resultsSSModAdadelta$iter ## 264
mean(tail(resultsSSModAdadelta$param[, 1], 20), trim=.2)  ##  0.3733574
mean(tail(resultsSSModAdadelta$param[, 2], 20), trim=.2)  ##7.326004
mean(tail(resultsSSModAdadelta$param[, 3], 20), trim=.2)  ## 4.043387
mean(tail(resultsSSModAdadelta$param[, 4], 20), trim=.2)  ##   6.32914
...
timeSSModAdam  ## 17.547  
resultsSSModAdam$iter ## 300
mean(tail(resultsSSModAdam$param[, 1], 20), trim=.2)  ## 0.3082364
mean(tail(resultsSSModAdam$param[, 2], 20), trim=.2)  ## 7.344599
mean(tail(resultsSSModAdam$param[, 3], 20), trim=.2)  ##  5.388925
mean(tail(resultsSSModAdam$param[, 4], 20), trim=.2) ## 5.112593
