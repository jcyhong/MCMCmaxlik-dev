...
ut=rnorm(50,0,sd=sigmaU)
y=rep(ut[1]*exp(h[1]/2),50)
for(i in 2:50){
...
inits <- list(phi=.5,mu=10,sigmaEta=5,sigmaU=1.5)


## build the model object
svModel <- nimbleModel(svCode, constants = Consts,data=data,inits=inits)
#svModel <- nimbleModel(svCode, constants = Consts,inits=inits)
...
```{r compile}
compiledFunsSVmodel <- buildMCMCmaxlik(CsvModel, paramNodesSV)
...
init <- c(0.75,20,1,1.5)
boundary <- list(c(-.9999,0.9999),c(-1000,1000),c(0,1000),c(0,2))
numMCMCSamples <- 300
...
timesSVModFixed  ## 17.365

resultsSVModFixed$iter##  61
mean(tail(resultsSVModFixed$param[, 1], 20), trim=.2)  ## 0.75 
mean(tail(resultsSVModFixed$param[, 2], 20), trim=.2)  ## 20.00014
mean(tail(resultsSVModFixed$param[, 3], 20), trim=.2)  ## 33.11213
mean(tail(resultsSVModFixed$param[, 4], 20), trim=.2)  ## 1.766681
...
mean(tail(resultsSVModSmallFixed$param[, 3], 20), trim=.2)  ##  104.5691
mean(tail(resultsSVModSmallFixed$param[, 4], 20), trim=.2)  ##  1.98686
...
mean(tail(resultsSVModAdadelta$param[, 2], 20), trim=.2)  ## 20.01456
mean(tail(resultsSVModAdadelta$param[, 3], 20), trim=.2)  ## 11.08486
mean(tail(resultsSVModAdadelta$param[, 4], 20), trim=.2)  ## 1.999751
...
mean(tail(resultsSVModAdam$param[, 2], 20), trim=.2)  ##23.66279
mean(tail(resultsSVModAdam$param[, 3], 20), trim=.2)  ## 17.24817
mean(tail(resultsSVModAdam$param[, 4], 20), trim=.2)  ## 2
