...
svModel$calculate(svModel$getDependencies( c('rho','mu','sigPN','sigOE'), determOnly = TRUE))


## use the model to simulate states and data
set.seed(12345)
svModel$simulate( svModel$getDependencies(c('x','y')))
## Look at what we got:
svModel$x
svModel$y
svModel$setData('y')
...
svModMCEM <- buildMCEM(model=svMod2, latentNodes='x[1:100]',
